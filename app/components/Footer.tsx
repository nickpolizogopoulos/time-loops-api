...
const Footer = () => {
    return (
        <footer className="footer bg-base-200 text-base-content gap-7 p-10 xl:flex-row">
            ...
            <nav>
                <h6 className="footer-title">Legal</h6>
                {
                    legalLinks.map(link => 
                        <Link
                            key={link.path}
                            href={link.path} className="link link-hover"
                        >
                            {link.name}
                        </Link>
                    )
            ...
            <nav>
                ...
                <div className="grid grid-flow-col gap-4">
                    <Link href="https://www.linkedin.com/in/nickpolizogopoulos" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" className="hover:opacity-75 transition-all hover:scale-110" width="29" height="29" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <Link href="https://github.com/nickpolizogopoulos" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" className="hover:opacity-75 transition-all hover:scale-110" width="31" height="31" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <Link href="https://linktr.ee/nick_polizogopoulos" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" className="hover:opacity-75 transition-all hover:scale-110" width="31" height="31" fill="currentColor" viewBox="0 0 24 24" >
